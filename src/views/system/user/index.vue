      ...
      <div class="flex flex-col flex-grow min-w-0">
        ...
        <ElCard class="flex flex-col flex-1 min-h-0 art-table-card" shadow="never">
          ...
          <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
            <template #left>
              <ElSpace wrap>
                <ElButton v-permission="'saimulti:tenant:user:save'" @click="showDialog('add')" v-ripple>
                  <template #icon>
          ...
          >
            ...
            <template #operation="{ row }">
              <div class="flex gap-2" v-if="row.id !== 1 && userStore.info.id !== row.id">
                <SaButton
                  v-permission="'saimulti:tenant:user:update'"
                  type="secondary"
                  @click="showDialog('edit', row)"
                />
                <SaButton
                  v-permission="'saimulti:tenant:user:destroy'"
                  type="error"
                  ...
                  <template #dropdown>
                    <ElDropdownMenu>
                      <ElDropdownItem>
                        <div
                          class="flex-c gap-2"
                          v-permission="'saimulti:tenant:user:home'"
                      ...
                      <ElDropdownItem>
                        <div
                          class="flex-c gap-2"
                          v-permission="'saimulti:tenant:user:password'"
                      ...
                      <ElDropdownItem>
                        <div
                          class="flex-c gap-2"
                          v-permission="'saimulti:tenant:user:cache'"
