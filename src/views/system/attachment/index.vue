      ...
      <div class="flex flex-col flex-grow min-w-0">
        <ElCard class="art-table-card !mt-0" shadow="never">
          ...
          <div class="flex justify-between items-center mb-4">
            <ElSpace wrap>
              <ElUpload
                v-permission="'saimulti:tenant:uploadImage'"
                class="upload-btn"
              ...
              <ElButton
                v-permission="'saimulti:tenant:attachment:destroy'"
              ...
              <ElButton
                v-permission="'saimulti:tenant:attachment:edit'"
                :disabled="selectedRows.length === 0"
...
<script setup lang="ts">
  ...
  const getCategoryList = () => {
    api.category({ tree: true }).then((data: any) => {
      treeData.value = data
    })
  }
